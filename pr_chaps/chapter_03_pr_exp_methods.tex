...
\begin{figure}[hT!]
	...
	\caption{Emission of two successive radiations $X_1$ and $X_2$ from an oriented nuclear state, $I_1$.\label{fig:chp3-DCO-diagram-lvl-scheme}}
\end{figure}
