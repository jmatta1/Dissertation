...
\end{equation}
Here $N_{\perp}$ and $N_{\parallel}$ are the number of coincidence counts between segments of a clover detector in the direction perpendicular and parallel to the emission plane (defined by the beam axis and the gamma ray emission direction), respectively. The parameter $a(E_{\gamma})$ is the correction for any natural asymmetry in the response of the clover segments as a function of gamma-ray energy. This correction is defined as:
\begin{equation}
...
\end{equation}
With the fit to the natural asymmetries one is ready to calculate the polarization asymmetry $A$. If $A>0$ the transitions in question is predominantly electric in nature, if $A<0$ the transition is predominantly magnetic in nature.